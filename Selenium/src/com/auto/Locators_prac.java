...
public class Locators_prac {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.className("submit")).click(); // If there is a space b/w two words inside the class then
															// it is considered as two class, we can use any one of that
